  ...
  class Manager extends protocol.TypertRemoteService {
    ...
    async changePlugin(request) {
      ...
      try {
        ...
        await syncThirdPartyPlugins({ profileDir, repositoryPath, profile: this.profile })
    ...
    async restoreEnvironment() {
      ...
      this.running = true
      try {
        await applyEnvironment({ dshHomePath: this.dshHome, dataRootPath: config.dataLocalPath, profile: this.profile, restoreOnly: true })
