...
export const PRIVATE_ENABLEMENT_BEGIN = '# dsh-plugin-manager: begin managed enablement'
export const PRIVATE_ENABLEMENT_END = '# dsh-plugin-manager: end managed enablement'
...
function withPatchLock(path, callback) {
  const lock = `${path}.dsh-plugin-manager.lock`
