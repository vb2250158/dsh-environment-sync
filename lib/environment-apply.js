...
import { assertNoPendingTakeover } from './stale-takeover.js'
...
export async function applyEnvironment(options) {
  ...
  try { assertNoPendingTakeover(directory); return await applyEnvironmentOnce(options) } finally { await release() }
}
